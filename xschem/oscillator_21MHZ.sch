...
N 440 -2.5 462.5 -2.5 {
lab=OUT}
C {inverter.sym} -5 0 0 0 {name=x1[20:0]}
C {devices/iopin.sym} -172.5 -92.5 0 0 {name=p1 lab=VCC}
C {devices/iopin.sym} -172.5 -67.5 0 0 {name=p2 lab=VSS}
C {devices/lab_wire.sym} 182.5 0 0 0 {name=p4 sig_type=std_logic lab=INI[19:0],OUT_INI}
C {devices/lab_wire.sym} -72.5 0 0 0 {name=p5 sig_type=std_logic lab=OUT_INI,INI[19:0]}
